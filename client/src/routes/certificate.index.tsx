      ...
      <div className="rounded-xl border border-border bg-card p-5 shadow-sm sm:p-8">
        ...
        >
          <input
            ...
            className="min-w-0 flex-1 rounded-md border border-input bg-background px-3 py-2.5 font-mono text-sm uppercase text-foreground placeholder:font-sans placeholder:text-muted-foreground focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring"
          />
          <button
            type="submit"
            className="w-full shrink-0 rounded-md bg-primary px-4 py-2.5 text-sm font-medium text-primary-foreground hover:bg-primary/90 sm:w-auto"
          >
            Verify
          </button>
        </form>
