...
const rhymePairs: [string, string][] = [
  ...
  ["Which word rhymes with 'tree'?", "bee"],
  ["Which word rhymes with 'cake'?", "lake"],
  ["Which word rhymes with 'boat'?", "coat"],
  ["Which word rhymes with 'ring'?", "sing"],
  ["Which word rhymes with 'star'?", "car"],
  ["Which word rhymes with 'mouse'?", "house"],
  ["Which word rhymes with 'bell'?", "shell"],
  ["Which word rhymes with 'pen'?", "hen"],
  ["Which word rhymes with 'blue'?", "shoe"],
  ["Which word rhymes with 'night'?", "light"],
  ["Which word rhymes with 'chair'?", "hair"],
  ["Which word rhymes with 'duck'?", "truck"],
  ["Which word rhymes with 'snake'?", "rake"],
  ["Which word rhymes with 'clock'?", "sock"],
  ["Which word rhymes with 'goat'?", "boat"],
  ["Which word rhymes with 'frog'?", "log"],
  ["Which word rhymes with 'bug'?", "rug"],
];
...
const bodyFacts: [string, string][] = [
  ...
  ["What do we use to taste?", "Our tongue"],
  ["What do we use to hold things?", "Our hands"],
  ["What do we use to walk?", "Our legs"],
  ["How many fingers are on one hand?", "5"],
  ["How many toes are on two feet?", "10"],
  ["How many eyes do we have?", "2"],
  ["What covers our body?", "Skin"],
  ["What grows on our head?", "Hair"],
  ["What do we chew food with?", "Our teeth"],
  ["Which part of the body pumps blood?", "The heart"],
  ["Which part helps us think?", "The brain"],
  ["What do we breathe with?", "Our lungs"],
  ["What joins the hand to the arm?", "The wrist"],
  ["What is between the leg and the foot?", "The ankle"],
  ["What is in the middle of the face?", "The nose"],
  ["What do we use to speak?", "Our mouth"],
  ["How many ears do we have?", "2"],
];

const foodFacts: [string, string][] = [
  ["Which fruit is yellow and curved?", "A banana"],
  ["Which fruit is red and round?", "An apple"],
  ["Which fruit has many small seeds outside?", "A strawberry"],
  ["Which fruit is orange and juicy?", "An orange"],
  ["Which vegetable is orange and long?", "A carrot"],
  ["Which vegetable makes us cry?", "An onion"],
  ["Which food comes from a cow?", "Milk"],
  ["Which food comes from a hen?", "Eggs"],
  ["Which food is made from wheat flour?", "Bread"],
  ["Which drink comes from oranges?", "Orange juice"],
  ["Which fruit is green with a red inside?", "A watermelon"],
  ["Which vegetable has green leaves?", "Spinach"],
  ["Which food gives us energy?", "Rice"],
  ["Which food helps build strong bones?", "Milk"],
  ["Which food should we eat many of every day?", "Fruits and vegetables"],
  ["What do bees make that we eat?", "Honey"],
  ["Which fruit grows on a palm tree?", "A coconut"],
  ["Which vegetable is round and red in salads?", "A tomato"],
  ["Which food is cooked from maize flour?", "Porridge"],
  ["What must we drink every day to stay healthy?", "Water"],
];

const communityFacts: [string, string][] = [
  ["Who teaches children at school?", "A teacher"],
  ["Who helps sick people?", "A doctor"],
  ["Who puts out fires?", "A firefighter"],
  ["Who keeps people safe from crime?", "A police officer"],
  ["Who grows our food?", "A farmer"],
  ["Who bakes bread?", "A baker"],
  ["Who cuts hair?", "A barber"],
  ["Who drives a bus?", "A driver"],
  ["Who flies an aeroplane?", "A pilot"],
  ["Who builds houses?", "A builder"],
  ["Who sells things in a shop?", "A shopkeeper"],
  ["Who takes care of teeth?", "A dentist"],
  ["Who delivers letters?", "A postal worker"],
  ["Who cooks in a restaurant?", "A chef"],
  ["Who repairs cars?", "A mechanic"],
  ["Who takes care of animals?", "A veterinarian"],
  ["Who is the head of a school?", "The head teacher"],
  ["Who helps a doctor care for patients?", "A nurse"],
  ["Where do we go when we are very sick?", "The hospital"],
  ["Where do we buy food?", "The market"],
];
...
export const earlyExtraTopics: SectionDefinition[] = [
  genSection(
    "early-counting-order",
    "Counting Order",
    "What comes next and what comes before, from 1 to 100.",
    "Easy",
    (index, random) => {
  ...
  genSection(
    "early-add-ten",
    "Adding to Ten",
    "Gentle addition sums within twenty.",
    "Easy",
    (_i, random) => {
  ...
  genSection(
    "early-take-away",
    "Taking Away",
    "Simple subtraction for first-time learners.",
    "Easy",
    (_i, random) => {
      ...
      return draft(
        ...
        String(a - b),
        numericOptions(a - b, 3),
        `Taking ${b} away from ${a} leaves ${a - b}.`,
      );
    },
  ),
  genSection(
    "early-bigger-smaller",
    "Bigger and Smaller",
  ...
  genSection(
    "early-patterns",
    "Patterns & Sorting",
    "Spot the repeating pattern and say what comes next.",
    "Easy",
    (index, random) => {
  ...
  factSection(
    "early-rhymes",
    "Rhyming Words",
    "Hearing words that end with the same sound.",
    "Easy",
    rhymePairs,
  ),
  factSection(
    "early-body",
    "My Body",
    "Body parts and what each one helps us do.",
    "Easy",
    bodyFacts,
  ),
  factSection(
    "early-food",
    "Food & Healthy Eating",
    "Fruits, vegetables and healthy choices.",
    "Easy",
    foodFacts,
  ),
  factSection(
    "early-community",
    "People Who Help Us",
    "Community helpers and the places they work.",
    "Easy",
    communityFacts,
  ),
  factSection(
    "early-position",
    "Position & Opposites",
    "In, on, under, above and everyday opposites.",
    "Easy",
    positionFacts,
  ),
  genSection(
    "early-shapes-count",
    "Shapes & Sides",
    "Counting the sides and corners of simple shapes.",
    "Easy",
    (index, _random) => {
  ...
  genSection(
    "early-money-coins",
    "Counting Coins",
    "Adding up small amounts of money.",
    "Easy",
    (_i, random) => {
...
const spellingFacts: [string, string][] = [
  ...
  ["Which of these is spelled correctly?", "friend"],
  ["What is the plural of 'child'?", "children"],
  ["What is the plural of 'mouse'?", "mice"],
  ["What is the plural of 'box'?", "boxes"],
  ["What is the plural of 'baby'?", "babies"],
  ["What is the opposite of 'ancient'?", "modern"],
  ["What is the opposite of 'brave'?", "cowardly"],
  ["What is a word with the same meaning as 'happy'?", "joyful"],
  ["What is a word with the same meaning as 'big'?", "enormous"],
  ...
  ["What punctuation shows strong feeling?", "An exclamation mark"],
  ["What is a naming word called?", "A noun"],
  ["What is an action word called?", "A verb"],
  ["What word describes a noun?", "An adjective"],
  ["What word replaces a noun?", "A pronoun"],
  ["What do we call a group of words with a subject and verb?", "A sentence"],
];
...
const healthFacts: [string, string][] = [
  ...
  ["Which vitamin is found in oranges?", "Vitamin C"],
  ["What disease is caused by lack of vitamin C?", "Scurvy"],
  ["What spreads germs most easily?", "Dirty hands"],
  ["Why should we cover our mouth when coughing?", "To stop germs spreading"],
  ["How many hours of sleep do children need?", "About 9 to 11"],
  ["What should we do with rubbish?", "Put it in a bin"],
  ["What kills germs when washing hands?", "Soap"],
  ["Why should we boil drinking water?", "To kill germs"],
  ["What protects us against disease after a vaccine?", "Immunity"],
  ["What insect spreads malaria?", "The mosquito"],
  ["What should we wear in strong sunshine?", "A hat and sunscreen"],
  ["Why is exercise important?", "It keeps the heart and body strong"],
  ["What should we do before cooking?", "Wash hands and clean surfaces"],
  ["What is a balanced diet?", "Food from all the main groups"],
];
...
const capitalFacts: [string, string][] = [
  ...
  ["What is the capital of South Africa (legislative)?", "Cape Town"],
...
export const primaryExtraTopics: SectionDefinition[] = [
  genSection(
    "primary-times-tables",
    "Times Tables",
    "Multiplication facts from 2 to 12.",
    "Easy",
    (_i, random) => {
  ...
  genSection(
    "primary-division",
    "Division Facts",
    "Sharing equally and finding exact quotients.",
    "Easy",
    (_i, random) => {
      const b = int(random, 2, 12);
      ...
      return draft(
        ...
        `${b} × ${answer} = ${b * answer}, so the answer is ${answer}.`,
      );
    },
  ),
  genSection(
    "primary-fractions",
    "Fractions",
    "Halves, quarters and fractions of amounts.",
    "Medium",
    (_i, random) => {
  ...
  genSection(
    ...
    (index, random) => {
      ...
      if (kind === 0)
        return draft(
          `How many centimetres are in ${value} metres?`,
          String(value * 100),
          numericOptions(value * 100, 50),
          `1 metre = 100 cm, so ${value} m = ${value * 100} cm.`,
        );
      if (kind === 1)
        return draft(
          `How many grams are in ${value} kilograms?`,
          String(value * 1000),
          numericOptions(value * 1000, 500),
          `1 kg = 1000 g, so ${value} kg = ${value * 1000} g.`,
        );
      return draft(
        `How many millilitres are in ${value} litres?`,
        String(value * 1000),
        numericOptions(value * 1000, 500),
        `1 litre = 1000 ml, so ${value} l = ${value * 1000} ml.`,
      );
    },
  ),
  genSection(
    "primary-time",
    "Telling the Time",
    "Reading clocks and working with minutes.",
    "Easy",
    (index, random) => {
      const minutes = int(random, 1, 11) * 5;
      if (index % 2 === 0) {
        return draft(
          `How many minutes are in ${minutes} × 1 minute plus one hour?`,
          String(minutes + 60),
          numericOptions(minutes + 60, 10),
          `One hour is 60 minutes, plus ${minutes} makes ${minutes + 60}.`,
        );
      }
  ...
  genSection(
    "primary-money",
    "Money & Shopping",
    "Change, totals and simple budgeting.",
    "Medium",
    (_i, random) => {
  ...
  factSection(
    "primary-spelling",
    "Spelling & Grammar",
    "Plurals, tenses, punctuation and word classes.",
    "Easy",
    spellingFacts,
  ),
  factSection(
  ...
  factSection(
    "primary-world",
    "World Geography",
    "Capitals, continents, rivers and landmarks.",
    "Easy",
    capitalFacts,
  ),
];
...
const chemFacts: [string, string][] = [
  ...
  ["Which particle has no charge?", "The neutron"],
  ["What is the centre of an atom called?", "The nucleus"],
];

const bioFacts: [string, string][] = [
  ["What is the basic unit of life?", "The cell"],
  ["Which organelle makes energy in a cell?", "The mitochondrion"],
  ["Which organelle contains DNA?", "The nucleus"],
  ...
  ["What carries messages around the body?", "Nerves"],
  ["What is the molecule that stores genetic information?", "DNA"],
  ["How many chromosomes do humans have?", "46"],
  ["What is the process of cell division for growth?", "Mitosis"],
  ["What produces gametes?", "Meiosis"],
  ["What is an organism that makes its own food called?", "A producer"],
...
const historyFacts: [string, string][] = [
  ...
  ["What was the trade route linking Asia and Europe?", "The Silk Road"],
  ["What revolution began in Britain in the 1700s?", "The Industrial Revolution"],
...
const litFacts: [string, string][] = [
  ["What is a comparison using 'like' or 'as'?", "A simile"],
  ["What is a direct comparison without 'like'?", "A metaphor"],
  ["What is giving human traits to objects?", "Personification"],
  ["What is repetition of initial consonant sounds?", "Alliteration"],
  ["What is exaggeration for effect?", "Hyperbole"],
  ["What is a word imitating a sound?", "Onomatopoeia"],
  ["What is the sequence of events in a story?", "The plot"],
  ["What is the time and place of a story?", "The setting"],
  ["What is the central message of a text?", "The theme"],
  ["Who tells the story?", "The narrator"],
  ["What is a 14-line poem called?", "A sonnet"],
  ["What is the turning point of a plot?", "The climax"],
  ["What is a struggle between characters called?", "Conflict"],
  ["What is a hint of what will happen later?", "Foreshadowing"],
  ["What is the main character called?", "The protagonist"],
  ["What is the opposing character called?", "The antagonist"],
  ["What is a play's spoken text called?", "Dialogue"],
  ["What is a long narrative poem about a hero?", "An epic"],
  ["What is the writer's attitude to the subject?", "Tone"],
  ["What is a short story with a moral?", "A fable"],
];

const compFacts: [string, string][] = [
  ["What does CPU stand for?", "Central processing unit"],
  ["What is temporary working memory called?", "RAM"],
  ["What is permanent storage on a disk called?", "Secondary storage"],
  ["What does OS stand for?", "Operating system"],
  ["What is a set of instructions for a computer?", "A program"],
  ["What is the binary value for decimal 5?", "101"],
  ["How many bits are in a byte?", "8"],
  ["What device inputs printed images?", "A scanner"],
  ["What is unauthorised access to a system called?", "Hacking"],
  ["What software protects against viruses?", "Antivirus software"],
  ["What is a network within one building called?", "A LAN"],
  ["What connects networks worldwide?", "The internet"],
  ["What language styles a web page?", "CSS"],
  ["What language structures a web page?", "HTML"],
  ["What is a saved collection of related data?", "A database"],
  ["What is a unique field in a table called?", "The primary key"],
  ["What is a step-by-step procedure to solve a problem?", "An algorithm"],
  ["What diagram shows program logic?", "A flowchart"],
  ["What is data sent into a computer called?", "Input"],
  ["What converts source code to machine code?", "A compiler"],
];
...
export const secondaryExtraTopics: SectionDefinition[] = [
  genSection(
    ...
    "Trigonometry",
    "Sines, cosines and right-angle triangle work.",
    "Hard",
    (index, random) => {
  ...
  genSection(
    ...
    "Mean, median, range and simple probability.",
    "Medium",
    (index, random) => {
      if (index % 2 === 0) {
        const values = [
  ...
  genSection(
    "secondary-physics-numeric",
    "Applied Physics",
    "Speed, force, work and electrical calculations.",
    "Hard",
    (index, random) => {
      const kind = index % 3;
      if (kind === 0) {
        ...
        return draft(
          `An object travels ${distance} m in ${time} s. What is its speed (m/s, 2 d.p.)?`,
          speed.toFixed(2),
          numericOptions(speed, 3, 2),
      ...
      if (kind === 1) {
        ...
        return draft(
          `What force accelerates a ${mass} kg mass at ${acceleration} m/s²?`,
          `${force} N`,
          numericOptions(force, 5).map((v) => `${v} N`),
      ...
      return draft(
        `What current flows when ${voltage} V is applied across ${resistance} Ω?`,
        `${current.toFixed(2)} A`,
  ...
  factSection(
    "secondary-chemistry-formulas",
    "Chemistry Essentials",
    "Formulas, symbols, bonding and atomic structure.",
    "Medium",
    chemFacts,
  ),
  factSection(
    "secondary-human-biology",
    "Human Biology",
    "Cells, organs, systems and genetics.",
    "Medium",
    bioFacts,
  ),
  factSection(
    ...
    "World History",
    "Key events, leaders and turning points.",
    "Medium",
    historyFacts,
  ),
  factSection(
...
const envFacts: [string, string][] = [
  ...
  [
    "What is an environmental impact assessment for?",
    "Assessing a project's environmental effects",
  ],
...
export const collegeExtraTopics: SectionDefinition[] = [
  ...
  genSection(
    "college-probability",
    "Probability Theory",
    "Combinatorics, independence and expected value.",
    "Hard",
    (index, random) => {
      if (index % 2 === 0) {
        ...
        return draft(
          `How many ways can ${n} distinct items be arranged?`,
          String(factorial),
          numericOptions(factorial, Math.max(2, Math.round(factorial * 0.2))),
          `${n}! = ${factorial}.`,
        );
      }
  ...
  factSection(
    ...
    "Business Law",
    "Contracts, torts, companies and intellectual property.",
    "Medium",
    lawFacts,
  ),
  factSection(
    ...
    "Complexity, sorting, trees and graphs.",
    "Hard",
    dsFacts,
  ),
  factSection(
  ...
  factSection(
    ...
    "Ecosystems, pollution, climate and sustainability.",
    "Medium",
    envFacts,
  ),
  factSection(
    ...
    "Research Methods",
    "Design, sampling, validity, statistics and ethics.",
    "Medium",
    researchFacts,
  ),
  genSection(
    "college-percentages-finance",
    "Business Mathematics",
    "Interest, percentages and financial calculations.",
    "Medium",
    (index, random) => {
      ...
      if (index % 2 === 0) {
        ...
        return draft(
          `What is ${rate}% simple interest on ${principal} for one year?`,
          String(interest),
          numericOptions(interest, principal / 20),
...
primaryExtraTopics.push(
  genSection(
    "primary-place-value",
    "Place Value",
    "Tens, hundreds and thousands in whole numbers.",
    "Easy",
    (index, random) => {
...
collegeExtraTopics.push(
  genSection(
    "college-calculus-drills",
    "Calculus Drills",
    "Differentiating and integrating polynomial terms.",
    "Hard",
    (index, random) => {
...
collegeExtraTopics.push(
  factSection(
    ...
    "Project Management",
    "Scope, schedule, risk, quality and stakeholder control.",
    "Medium",
    [
