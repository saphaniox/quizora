...
export const COUNTRIES: CountryDialCode[] = [
  ...
  { iso: "AX", name: "Aland Islands", dialCode: "+358" },
  ...
  { iso: "AQ", name: "Antarctica", dialCode: "+672" },
  ...
  { iso: "KP", name: "Korea, North", dialCode: "+850" },
  { iso: "KR", name: "Korea, South", dialCode: "+82" },
  ...
  { iso: "TR", name: "Turkiye", dialCode: "+90" },
  { iso: "TM", name: "Turkmenistan", dialCode: "+993" },
  { iso: "TC", name: "Turks and Caicos Islands", dialCode: "+1" },
  ...
  { iso: "VG", name: "Virgin Islands, British", dialCode: "+1" },
  { iso: "VI", name: "Virgin Islands, U.S.", dialCode: "+1" },
