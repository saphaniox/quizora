...
const networkingBank = () => [
  ...fromMap(
    [
      ["What port does HTTP use by default?", "80"], ["What port does HTTPS use by default?", "443"],
      ["What port does SSH use by default?", "22"], ["What port does DNS use by default?", "53"],
      ["What port does SMTP use by default?", "25"], ["What port does FTP use for control?", "21"],
      ["What port does RDP use?", "3389"], ["What port does PostgreSQL use?", "5432"],
      ["How many layers are in the OSI model?", "7"], ["Which OSI layer routes packets?", "The network layer"],
      ["Which OSI layer handles MAC addresses?", "The data link layer"], ["Which protocol assigns IP addresses automatically?", "DHCP"],
      ["Which protocol resolves names to IP addresses?", "DNS"], ["What device forwards traffic between networks?", "A router"],
      ["What device forwards frames inside a LAN?", "A switch"], ["What is a private IPv4 range?", "192.168.0.0/16"],
      ["How many bits are in an IPv4 address?", "32"], ["How many bits are in an IPv6 address?", "128"],
      ["What is the loopback address in IPv4?", "127.0.0.1"], ["Which protocol is connection-oriented?", "TCP"],
      ["Which protocol is connectionless?", "UDP"], ["What translates private addresses to public ones?", "NAT"],
      ["What filters traffic based on rules?", "A firewall"], ["What creates an encrypted tunnel over the internet?", "A VPN"],
      ["What attack floods a service with traffic?", "A DDoS attack"], ["What attack tricks users into revealing credentials?", "Phishing"],
      ["What authentication uses two different factors?", "Multi-factor authentication"], ["What encrypts web traffic?", "TLS"],
      ["What tool tests reachability of a host?", "ping"], ["What tool traces the path packets take?", "traceroute"],
      ["What is the maximum standard Ethernet frame payload?", "1500 bytes"], ["What is a subnet mask used for?", "Splitting network and host bits"],
      ["What is the broadcast address of 192.168.1.0/24?", "192.168.1.255"], ["What is a DMZ in networking?", "A network segment exposed to the internet"],
      ["What backup strategy keeps three copies?", "The 3-2-1 rule"], ["What is data availability protection using disks?", "RAID"],
      ["What is the first step of incident response?", "Identification"], ["What does SLA stand for?", "Service Level Agreement"],
      ["What is patch management for?", "Keeping systems updated against vulnerabilities"], ["What is the principle of least privilege?", "Granting only the access needed"],
    ] as [string, string][],
    (k) => k,
    (_k, v) => `The correct answer is: ${v}.`,
  ),
...
const financeBank = () => [
  ...fromMap(
    [
      ...
      ["What analysis reviews political, economic, social and technological factors?", "PESTEL analysis"],
...
const projectBank = () =>
  fromMap(
    [
      ...
      ["What is the best response to a high-impact, high-probability risk?", "Avoid or mitigate it"],
...
const safetyBank = () =>
  fromMap(
    [
      ...
      ["What is the most effective control in the hierarchy of controls?", "Elimination of the hazard"],
      ...
      ["What training is required before using new equipment?", "Competency and induction training"],
      ["What is the purpose of a toolbox talk?", "A short briefing on task-specific hazards"],
      ["What should be reported immediately after a serious injury?", "The incident to management and authorities"],
      ...
      ["What is the correct response to a chemical splash in the eye?", "Rinse with clean water for 15 minutes"],
      ...
      ["What is the safe practice around live electrical work?", "Avoid it; isolate and prove dead first"],
      ["What is the correct order of emergency actions?", "Raise the alarm, evacuate, call responders"],
