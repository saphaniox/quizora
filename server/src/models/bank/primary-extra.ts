...
const healthFacts: [string, string][] = [
  ...
  ["What should you do if someone pressures you to go somewhere unsafe?", "Refuse, leave and tell a trusted person"],
...
export const primaryExtraSections: SectionDefinition[] = [
  { id: "foundations-money-time", name: "Money & Time", description: "Shopping change, prices, clocks and calendars.", difficulty: "Easy", build: moneyTimeBank },
  { id: "foundations-reading", name: "Reading & Grammar", description: "Parts of speech, punctuation, spelling and sentences.", difficulty: "Easy", build: readingBank },
  { id: "foundations-health", name: "Health & Hygiene", description: "Personal hygiene, nutrition, safety and staying well.", difficulty: "Easy", build: healthBank },
  { id: "foundations-reasoning", name: "Everyday Problem Solving", description: "Number patterns and simple real-life word problems.", difficulty: "Easy", build: reasoningBank },
];
